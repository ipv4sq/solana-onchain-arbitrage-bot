...
impl InputAccountUtil<MeteoraDlmmInputAccounts, MeteoraDlmmPoolData> for MeteoraDlmmInputAccounts {
    ...
    fn build_accounts_no_matter_direction_size(
        ...
        let event_authority =
            Pubkey::find_program_address(&[b"__event_authority"], &PoolOwnerPrograms::METEORA_DLMM).0;

        Ok(MeteoraDlmmInputAccounts {
            lb_pair: pool.to_writable(),
            bin_array_bitmap_extension: PoolOwnerPrograms::METEORA_DLMM.to_program(),
            ...
            host_fee_in: PoolOwnerPrograms::METEORA_DLMM.to_program(),
            user: payer.to_signer(),
            token_x_program,
            token_y_program,
            event_authority: event_authority.to_readonly(),
            program: PoolOwnerPrograms::METEORA_DLMM.to_program(),
