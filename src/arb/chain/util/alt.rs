...
mod tests {
    ...
    async fn test_fetch_address_lookup_tables() {
        ...
        assert!(!alts[0].addresses.is_empty(), "First ALT should have addresses");
        assert!(!alts[1].addresses.is_empty(), "Second ALT should have addresses");
        
        let expected_addresses = [
            ("Fast9vhcG2TsyBYmaZDXtXDsNfSDDu9fk9VTLEzpJu1i".to_pubkey(), 0),
            ("SLowcKi5NofH9rjKQJBhyuFjqRvvdLGHnXrjYzzJ6fg".to_pubkey(), 0),
            ("BjJhrvVBtULMJDT9bCGKmDXz22YC1t75P1nF2yoRZj8E".to_pubkey(), 1),
            ("CL17xAu4Jy6CTwWoMNUcCgS6P4T4VnaNCGtnDjX66Ui5".to_pubkey(), 1),
        ];
